...
//        )?.top ?: 0
//
//        fa.viewLocation[1] = fa.viewLocation[1] - topBarHeight
//    }
...
//        cloneViewLocationAndSize(viewToClipTo)
        ...
        val dialogContainer = getChildAt(1) as RoundContainer
        dialogContainer.addView(dialogContent)

        val dialogCs = ConstraintSet()
        dialogCs.clone(this)

        dialogContainer.setPadding(dialogBackgroundPadding.toInt())
